...
export default function SMEPerformanceOptimizationComponent() {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                ...
                <div className="bg-white p-4 shadow rounded-md">
                    ...
                    <div className="mt-3">
                        ...
                        <button
                            onClick={() => alert("Analyzing suspicious patterns...")}
                ...
                <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white p-4 shadow rounded-md">
                        ...
                        <div className="mt-3">
                            ...
                            <ul className="list-disc list-inside mt-1 text-xs text-gray-600">
                                <li>AI-powered cost-saving recommendations.</li>
                                <li>Automated budget allocation suggestions.</li>
                            </ul>
