...
const fraudDetectionData = {
    labels: ['Duplicate Transactions', 'Missing Data'],
    datasets: [{ data: [5, 3], backgroundColor: ['#ef4444', '#f97316'], borderRadius: 4 }]
};
...
export default function StartupPerformanceOptimizationComponent() {
